...
const gpios = {
  5: new onoff.Gpio(26, 'out'),
  10: new onoff.Gpio(6, 'out'),
  20: new onoff.Gpio(5, 'out'),
  30: new onoff.Gpio(22, 'out'),
  50: new onoff.Gpio(27, 'out'),
};

const devices = [12, 20, 21].map(pin => new onoff.Gpio(pin, 'out'));
